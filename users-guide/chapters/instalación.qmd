...
El proceso de instalación del plugin {{< var plugin.name >}} para Moodle
...
2. Dentro de _releases_ se encuentran los manuales de usuario, el
   ...
   Este fichero el formato ` dalek-nightly-YYYMMDD.zip` que se
...
2. En la página de configuración, introduce tu **API Key** de OpenAI.
   Esta clave es necesaria para que el plugin pueda generar preguntas y
...
Asegúrate de que el plugin aparece en la lista de actividades
...
- **El plugin no aparece en las actividades**
